...
## 📰 News
**[2025.4.12]** Added grayscale support for pretraining; now supports configurable tubelet sizes (not just the default 2), as well as adjustable patch sizes and image resolutions (previously hardcoded).<br>
